...
- Run the program by:
  - make a split terminal
  - change the directory to server by entering "cd server" into the first terminal, then enter "node server.js";
  - In the second terminal enter the client by entering "cd client" then enter "npm run start"
